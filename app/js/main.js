$(function () {
  $(".menu__list-link--active").on("click", function (e) {
  ...
  const map = L.map("map").setView([40.71238004031695, -74.00560845746244], 10);
  ...
  L.marker([40.71238004031695, -74.00560845746244])
    .addTo(map)
    // .bindPopup("A pretty CSS popup.<br> Easily customizable.")
    .openPopup();

  if (!document.querySelector(".promo__clock")) return;
